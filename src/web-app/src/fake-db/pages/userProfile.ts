...
export const db: DB = {
  users: {
    profile: {
      about: [
        ...
        { property: 'Role', value: 'Investor', icon: 'ri-star-line' },
        { property: 'Country', value: 'Uganda', icon: 'ri-flag-line' },
        { property: 'Language', value: 'English', icon: 'ri-translate-2' }
      ],
      contacts: [
        { property: 'Contact', value: '(256) 356-553-7890', icon: 'ri-phone-line' },
        { property: 'Skype', value: 'john.doe', icon: 'ri-wechat-line' },
        { property: 'Email', value: 'john.doe@innolink.com', icon: 'ri-mail-open-line' }
      ],
      teams: [
  ...
  profileHeader: {
    ...
    profileImg:
      'https://images.unsplash.com/photo-1546525848-3ce03ca516f6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fGJsYWNrJTIwcGVyc29ufGVufDB8fDB8fHww',
    designationIcon: 'ri-palette-line',
    coverImg:
      'https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGJ1c2luZXNzJTIwaW1hZ2V8ZW58MHx8MHx8fDA%3D'
  }
}
