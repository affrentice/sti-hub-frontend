...
export const chipColor: { [key: string]: chipColorType } = {
  Matchmaking: { color: 'primary' },
  'Grants Opportunities': { color: 'success' },
  'Research Publication': { color: 'info' },
  'Community Engagement': { color: 'secondary' },
  'Project Management': { color: 'warning' },
  'Investor Directory': { color: 'error' },
  'Event Management': { color: 'primary' },
  'Content Sharing': { color: 'success' }
}
