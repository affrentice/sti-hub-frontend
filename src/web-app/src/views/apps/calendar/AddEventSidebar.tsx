  ...
  const resetToStoredValues = useCallback(() => {
    if (calendarStore.selectedEvent !== null) {
      ...
      setValues({
        ...
        calendar: event.extendedProps.calendar || 'Matchmaking',
          ...
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            <FormControl fullWidth className='mbe-6'>
              ...
              >
                ...
                <MenuItem value='Grants Opportunities'>Grants Opportunities</MenuItem>
                ...
                <MenuItem value='Investor Directory'>Investor Directory</MenuItem>
                <MenuItem value='Event Management'>Event Management</MenuItem>
                <MenuItem value='Content Sharing'>Content Sharing</MenuItem>
                <MenuItem value='Performance Monitoring'>Performance Monitoring</MenuItem>
              </Select>
            </FormControl>
            <div className='mbe-6'>
              <AppReactDatepicker
