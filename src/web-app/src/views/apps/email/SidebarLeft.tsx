...
export const labelColors: { [key: string]: LabelColor } = {
  guidelines: { color: 'info', colorClass: 'text-info' },
  research: { color: 'primary', colorClass: 'text-primary' },
  policy: { color: 'warning', colorClass: 'text-warning' },
  event: { color: 'success', colorClass: 'text-success' },
  grants: { color: 'error', colorClass: 'text-error' }
}
